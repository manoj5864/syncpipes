...
let excelMysqlTransformer = function(mysqlService, excelDataFactory, dataFactory){
    "use strict";

    var controller = function($scope, mysqlService, excelDataFactory, dataFactory) {
        $scope.init = function() {
            ...
            //insert row
            var excelAsJson = excelDataFactory.getData();
...
excelMysqlTransformer.$inject = ['mysqlService', 'excelDataFactory', 'dataFactory'];
